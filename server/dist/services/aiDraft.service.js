...
export const aiDraftConfigured = () => Boolean(env.LLM_API_KEY);
...
export async function generateDraft(kind, lead) {
    const context = [
        `Lead name: ${lead.name}`,
    ...
    if (!draft)
        throw new Error("The AI drafter returned an empty response.");
    return draft;
}
//# sourceMappingURL=aiDraft.service.js.map