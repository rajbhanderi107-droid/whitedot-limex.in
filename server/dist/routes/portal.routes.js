...
import { updatePortalStateSchema, upsertAutomationSchema, createApprovalSchema, decideApprovalSchema, createWorkflowSchema, createIncidentSchema, updateIncidentSchema, upsertIntegrationSchema, upsertAiAgentSchema, aiDraftSchema, } from "../validators/portal.validator.js";
const router = Router();
