...
export async function listCalculatorSubmissions(req, res) {
...
export async function getCalculatorSubmission(req, res) {
    ...
    if (!submission)
        throw new AppError(404, "NOT_FOUND", "Calculator submission not found");
