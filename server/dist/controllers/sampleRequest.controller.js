...
export async function listSampleRequests(req, res) {
...
export async function getSampleRequest(req, res) {
    ...
    if (!sample)
        throw new AppError(404, "NOT_FOUND", "Sample request not found");
    return sendSuccess(res, sample);
}
export async function updateSampleRequest(req, res) {
    const id = paramId(req);
...
export async function deleteSampleRequest(req, res) {
    const id = paramId(req);
...
//# sourceMappingURL=sampleRequest.controller.js.map