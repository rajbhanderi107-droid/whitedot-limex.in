...
import { chatConfigured, generateChatReply } from "../services/chat.service.js";
/**
...
export async function chat(req, res) {
    if (!chatConfigured()) {
        return sendError(res, "CHAT_UNAVAILABLE", "The LIMEX assistant is not available right now. Please reach us on WhatsApp at +91 88497 28938.", 503);
    }
