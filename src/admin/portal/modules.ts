...
export const MODULE_GROUPS: ModuleGroup[] = [
  ...
  },
  {
    ...
    modules: [
      ...
      { key: "trial-book", label: "LIMEX Trial Book", icon: FlaskConical, path: "/admin/trial-book", status: "live",
        blurb: "Every LIMEX trial, in the same fifteen heads as the workbook.",
        features: ["The trial form, typed not pasted", "Numbered once, never reused", "Photo stays in the folder and Drive", "The laptop writes the workbook", "Folds into the trial master"] },
  ...
  // "AI Growth Studio" group parked in src/admin/portal/future-tools/ (see its README to restore).
  {
    title: "Product & Data",
    modules: [
