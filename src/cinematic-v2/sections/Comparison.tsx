...
const DATA: Record<Tab, Row[]> = {
  Purpose: [
    { category: 'Material intent', limex: 'Developed to reduce plastic consumption while supporting selected technical properties, at a lower per-kg cost.', filler: 'Typically added mainly to increase weight, with no change in cost.' },
