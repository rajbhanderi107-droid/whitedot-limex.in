  ...
  useEffect(() => {
    ...
    function applyCardTransforms() {
      ...
      grid!.querySelectorAll<HTMLElement>('.csp-pcard').forEach(c => {
        ...
        if ((product === 'bobbin' || product === 'container' || product === 'motorCover' || product === 'aralditeContainer' || product === 'handWashBottle' || product === 'hardDish' || product === 'consilePipe' || product === 'soapStand' || product === 'foodOilCan' || product === 'dairyProductsContainer') && absT < nearestDistance) {
    ...
    if (!isMobileViewport) {
      document.querySelectorAll<HTMLElement>('.csp-pcard.live').forEach(c => {
        ...
        c.addEventListener('mouseenter', () => {
          const product = c.dataset.product as ProductKey | undefined;
          if (product === 'bobbin' || product === 'container' || product === 'motorCover' || product === 'aralditeContainer' || product === 'handWashBottle' || product === 'hardDish' || product === 'consilePipe' || product === 'soapStand' || product === 'foodOilCan' || product === 'dairyProductsContainer') setActiveProductKey(product);
        });
