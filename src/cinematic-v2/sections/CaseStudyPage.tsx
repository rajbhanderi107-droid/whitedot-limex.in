...
const toiletBrushHandleModel = `${basePath}/case-study/model/case-40-toilet-brush-handle.glb?v=slim-side-20260926`;
...
export default function CaseStudyPage() {
  ...
  // initial load. observeMobileModelPool promotes products as their cards
  // actually approach the viewport.
  ...
  useEffect(() => {
    ...
    // the tab on load. The LRU pool's IntersectionObserver + its
    ...
    // even though the subheading right above it promises the stats change as
    // you pick a product. A scrollspy is the cheap equivalent: a thin band
    // across the middle of the viewport, so the panel follows whichever card
    // the user has scrolled to. IntersectionObserver only fires on band
    ...
    <>
      ...
      <a className="csp-pcard featured live" href={motorCoverHref} data-product="motorCover">
        ...
        <div className="csp-pinfo">
          <div>
            ...
            <Composition k="motorCover">Material spec pending</Composition>
          </div>
          <span className="csp-pgo">-&gt;</span>
        </div>
      </a>
      ...
      <a className="csp-pcard featured live" href={dairyContainerHref} data-product="dairyContainer">
        ...
        <div className="csp-pmedia">
          ...
          {(activeModels.has('dairyContainer')) ? (
            // @ts-ignore custom element
            <model-viewer
        ...
        <div className="csp-pinfo">
          <div>
            ...
            <Composition k="dairyContainer">Material spec pending</Composition>
          </div>
          <span className="csp-pgo">-&gt;</span>
        </div>
      </a>
    ...
    <div className="v2-root">
      ...
      <main className="csp-main">
        <div className="csp-page">
          ...
          <p className="csp-page-footer">© 2026 White Dot · All rights reserved · LIMEX is a trademark of TBM Co., Ltd.</p>
        </div>
      </main>
      <Footer />
    </div>
