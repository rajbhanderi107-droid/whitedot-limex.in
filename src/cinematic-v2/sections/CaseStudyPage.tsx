  ...
  useEffect(() => {
    ...
    const product13Warmup = window.setTimeout(
      () => warmCaseStudyModelCache([
        ...
        toothBrushModel, petrolPipeModel, proteinContainerModel, rectangleBoxModel,
      ]),
      50,
    );
