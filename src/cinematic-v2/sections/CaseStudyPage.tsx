  ...
  useEffect(() => {
    ...
    const product13Warmup = window.setTimeout(
      () => warmCaseStudyModelCache([
        ...
        toothBrushModel, petrolPipeModel, proteinContainerModel, rectangleBoxModel, smallRoundBottleModel,
      ]),
      50,
    );
