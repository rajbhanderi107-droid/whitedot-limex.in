# Dermicool Powder Bottle  

- **id:** `dermicoolPowderBottle`  
- **index:** 29  
- **slug:** `dermicool-powder-bottle`  
- **category:** Personal Care Packaging  
- **status:** pending  

## Files
- Data: `public/case-study/data/products/dermicool-powder-bottle.json`
- 3D model: `MISSING — not yet built`
- HTML page: `product.html?p=dermicool-powder-bottle  (generic template, no dedicated file)`
