...
## Model
Photo-matched 3 litre bucket: pink body, white rim band, red snap lid with a
centre boss, red wire bail handle. Card orbit `20deg 76deg 112%` — the
container convention, low enough to show the handle.
