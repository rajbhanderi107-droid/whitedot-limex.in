...
- **id:** `motorFanBlade`  
- **index:** 18  
- **slug:** `motor-fan-blade`  
- **category:** Motor Component  
- **status:** pending  

## Files
- Data: `public/case-study/data/products/motor-fan-blade.json`
- 3D model: `MISSING — not yet built`
- HTML page: `product.html?p=motor-fan-blade  (generic template, no dedicated file)`
