...
- **id:** `smallRoundBottle`  
- **index:** 24  
- **slug:** `small-round-bottle`  
- **category:** General Packaging  
- **status:** pending  

## Files
- Data: `public/case-study/data/products/small-round-bottle.json`
- 3D model: `MISSING — not yet built`
- HTML page: `product.html?p=small-round-bottle  (generic template, no dedicated file)`
