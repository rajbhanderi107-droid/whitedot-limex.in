# Dairy Round Container  

- **id:** `dairyRoundContainer`  
- **index:** 13  
- **slug:** `dairy-round-container`  
- **category:** Dairy Packaging  
- **status:** pending  

## Files
- Data: `public/case-study/data/products/dairy-round-container.json`
- 3D model: `MISSING — not yet built`
- HTML page: `product.html?p=dairy-round-container  (generic template, no dedicated file)`
